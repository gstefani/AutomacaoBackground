...
class TibiaAutomation:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Tibia Auto Hotkey")
    ...
    def setup_ui(self):
        ...
        # Título
        title = tk.Label(main_frame, text="🎮 Tibia Auto Hotkey", 
        ...
        refresh_btn = tk.Button(main_frame, text="🔄 Atualizar Janelas", 
    ...
    def add_hotkey(self):
        ...
        if hotkey_frame:
            # Remover botão adicionar temporariamente
    ...
    def remove_hotkey(self, index):
        ...
        if len(self.hotkey_config) > 1 and index < len(self.hotkey_config):
            ...
            # Reatualizar índices dos widgets restantes
            for i in range(index, len(self.hotkey_widgets)):
    ...
    def send_key_to_window(self, hwnd, key):
        """Envia uma tecla para uma janela específica em background"""
        # Mapear teclas para virtual key codes
        key_map = {
